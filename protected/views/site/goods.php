<ul class="breadcrumbs breadcrumb">
    ...
    <li itemprop="child" itemscope itemtype="http://data-vocabulary.org/Breadcrumb" id="breadcrumb-1" itemref="breadcrumb-2">
        <a href="<?php echo Yii::app()->createUrl("site/goods", array("type"=>1)) ?>"><?php echo Yii::t('main', 'Коммуникаторы')?></a>
        <span class="divider">/</span>
    </li>
    <li itemprop="child" itemscope itemtype="http://data-vocabulary.org/Breadcrumb" id="breadcrumb-2" itemref="breadcrumb-3">
        <a href="<?php echo Yii::app()->createUrl("site/manufacturer"); ?>"><?php echo $data['manufacturer']?></a>
        <span class="divider">/</span>
    </li>
                        ...
                        <div class="infoGoodItem">
                            <div class="infoGoodItem-title">
                                <div class="infoGoodItem-title-1">
                                    <h1><?php echo $data['manufacturer']. " " .$data['name']?></h1>
                                </div>
                                <div class="infoGoodItem-title-2 clr">
                                    <div class="flLeft">
                                        ...
                                        <ul class="infoGoodItem-title-2_list">
                                            <li class="item1"><?php echo $data['rating']?></li>
                                            <li class="item2">91</li>
                                            <li class="item3"><?php echo $data['likes']?></li>
                                        </ul>
                                        <div class="clear"></div>
                                    </div>
                                    <div class="flRight">
                            ...
                            <div class="wpcontent">
                                <div class="infoGoodItem-wp-photos" id="item1">
                                    ...
                                    <?php elseif (count($data['images']) == 1): ?>
                                    <div class="infoGoodItem-wp-photos_main">
                                        <img style="max-width: 350px; height: auto;" src="<?php
                                        ...
                                        ?>" alt="<?php echo htmlspecialchars($data['manufacturer']. " " .$data['name'])?>" /> 
                                    </div>
                                    <?php else: ?>
                                    <div class="infoGoodItem-wp-photos_main">
