            ...
            <div class="infoGoodItem-wpcontent">
                ...
                <div class="wpcontent">
                    ...
                    <div class="infoGoodItem-wp-comments" id="item5">
                        ...
                        <?php endforeach; ?>
                            <script type="text/javascript" src="//www.google.ru/trends/embed.js?hl=ru&q=samsung+galaxy+s5,lg+g3,<?php echo urlencode($brand->name." ".$product->name)?>&cmpt=q&content=1&cid=TIMESERIES_GRAPH_0&export=5&w=500&h=330&date=today+12-m"></script>
