   <div class="informer-top">
        <div class="informer-t-left"><span class="informer-title"><?php echo $type->name->name?></span></div>
        <div class="informer-t-right">
            <nav id="informer-top-menu-<?=time()?>">
                <ul>
                    <li><a href="#" class="informer-icon-rating"></a></li>
                    <li id="price_li_informer-<?=time()?>"><a href="#" class="informer-icon-price"></a>
    ...
    <div class="informer-c">
        <ul class="informer-listGoods">
            ...
            <li>
                <div class="informer-listGoods_photo"><a href="<?php echo Yii::app()->createAbsoluteUrl("site/goods", array(
                        'link'=>$goods->link, 
                ...
                <div class="informer-listGoods_desc"><a href="<?php echo Yii::app()->createAbsoluteUrl("site/goods", array(
                        'link'=>$goods->link, 
                        'brand'=>$goods->brand_data->link,
                        'type'=>$goods->type_data->link, 
                        'language'=> Language::getCurrentZone()
    ...
    <div class="informer-bottom">
        <div class="informer-b-left"><img src="img/small/logo.png" height="17" width="79"></div>
