...
class PHPCrawler
{
  ...
  protected function createWorkingDirectory()
  {
    ...
    if (!file_exists($this->working_base_directory))
        mkdir($this->working_base_directory, 0777);
  ...
  {
      $this->PageRequest->addProxy($proxy_host, $proxy_port, $proxy_username, $proxy_password);
  }
