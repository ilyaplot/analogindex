...
class Goods extends CActiveRecord
{
    ...
    public function getGallery_count($limit = true)
    {
            ...
            if (!empty($items)) {
                ...
                foreach ($items as $item) {
                    ...
                    $result[$item['id']] = new CharacteristicItem(
                            $item['id'], $item['catalog_name'], $item['characteristic_name'], $item['formatter'], $item['characteristic_description'], $item['link'], $item['link_value'], $item['value'], $this, array(
